...
//    private BottomBar config;
    ...
    public AppBottomBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        BottomBar config = AppConfig.INSTANCE.getBottomBarConfig();
    ...
    private int getItemId(String pageUrl) {
        Destination destination = AppConfig.INSTANCE.getDestConfig().get(pageUrl);
        if (destination == null)
            return -1;
